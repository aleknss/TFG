...
import { getAvatarUrl } from "../services/usuario";
...
const Cuenta = () => {
  ...
  return (
    <div className="h-[calc(100vh_-_96px)] px-4 sm:px-12 md:px-36 lg:px-72 py-12 box-border gap-12 sm:gap-24 justify-start sm:justify-center flex flex-col items-center">
      <div
        className="flex flex-col sm:flex-row w-full max-w-4xl h-auto sm:h-3/6 gap-6 sm:gap-10"
        id="cuenta"
      >
          ...
          <div className="flex flex-col gap-4">
            ...
            {isEditingDesc ? (
              <div className="flex flex-col gap-2">
                <textarea
                  className="border rounded p-2 w-full text-base resize-none"
                  rows={4}
                  value={descripcion}
